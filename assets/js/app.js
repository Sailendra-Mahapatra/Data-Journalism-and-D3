...
// Creating SVG wrapper, appending an SVG group for chart to the left and top margins
...
d3.csv("assets/data/data.csv")
  ...
  .append("tspan")
   ...
   // Creating tool tip 
    ...
    // Adding event listeners for display/hide tooltip
